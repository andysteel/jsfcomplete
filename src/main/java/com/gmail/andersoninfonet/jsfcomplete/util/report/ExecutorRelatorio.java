package com.gmail.andersoninfonet.jsfcomplete.util.report;
...
public class ExecutorRelatorio implements Work{
	...
	public void execute(Connection connection) throws SQLException {
		try {
			File relatorio = new File(this.caminhoRelatorio);
			JasperPrint print = JasperFillManager.fillReport(relatorio.getPath(), this.parametros, connection);
			...
			if (this.relatorioGerado) {
				...
				response.setHeader("Content-Disposition", "filename=\"" + this.nomeArquivoSaida  + "\"");
